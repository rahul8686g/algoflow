...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-glow-primary hover:bg-primary/90 active:scale-[0.98]",
        destructive:
          "bg-destructive text-destructive-foreground shadow-glow-sell hover:bg-destructive/90 active:scale-[0.98]",
        outline:
        ...
        buy:
          "bg-buy/15 text-buy border border-buy/30 hover:bg-buy/25 shadow-glow-buy active:scale-[0.98]",
        sell:
          "bg-sell/15 text-sell border border-sell/30 hover:bg-sell/25 shadow-glow-sell active:scale-[0.98]",
      },
      size: {
