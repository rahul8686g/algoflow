  ...
  const updateMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: 'Your broker API settings have been updated.',
        variant: 'success',
      })
    },
    onError: (error: Error) => {
    ...
    onSuccess: (data) => {
      if (data.success) {
        ...
        toast({
          ...
          description: 'Successfully connected to broker API.',
          variant: 'success',
        })
      } else {
    ...
    <div className="mx-auto max-w-6xl px-6 py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Configure your broker API connection settings
        </p>
      </div>
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  Your broker API key for authentication
                </CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Leave empty to keep existing key. Get your API key from your broker dashboard.
              </p>
            </div>
          </CardContent>
        </Card>
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  Broker API server URL for REST API calls
                </CardDescription>
              </div>
            </div>
          </CardHeader>
